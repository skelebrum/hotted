                    ...
                    <div class="m-2 p-2">
                        <form method="POST" action="#">
                            ...
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                for="coach_photo">Upload file</label>
                            <input
                                class="block w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 cursor-pointer dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                                aria-describedby="coach_photo_help" id="coach_photo" type="file">
                            <div class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="coach_photo_help">Car photo</div>

                            <label class="inline-flex relative items-center mt-4 mb-4 cursor-pointer">
                                <input type="checkbox" value="" class="sr-only peer">
                                <div
                                    class="w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600">
                                </div>
                                <span class="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300">Reserved</span>
                            </label>
